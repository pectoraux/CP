// /eligibility/internal/placeholder.ts
// Private implementation surface for /eligibility. Reserved for the concrete
// implementation delivered in later work items. Importing this file (or any
// other file under @cp/eligibility/internal/*) from outside /eligibility is a
// forbidden cross-module internal import and is rejected by the static
// architecture check (architecture-lock §8).

export const INTERNAL_MODULE = "eligibility" as const;
