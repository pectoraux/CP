// /webhooks — public interface.
//
// Responsibility (architecture §36): external webhook ingestion.
//
...
// from this file. Importing @cp/webhooks/internal/* from outside this
...
export const MODULE_NAME = "webhooks" as const;
