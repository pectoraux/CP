// /plans — public interface.
//
// Responsibility (architecture §36): immutable execution plans/strategies.
//
...
// from this file. Importing @cp/plans/internal/* from outside this
...
export const MODULE_NAME = "plans" as const;
