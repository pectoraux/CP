// /plans/internal/placeholder.ts
// Private implementation surface for /plans. Reserved for the concrete
// implementation delivered in later work items. Importing this file (or any
// other file under @cp/plans/internal/*) from outside /plans is a
// forbidden cross-module internal import and is rejected by the static
// architecture check (architecture-lock §8).

export const INTERNAL_MODULE = "plans" as const;
