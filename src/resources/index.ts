...
//
// Responsibility (architecture §36): external resource references and resource state snapshots.
//
...
// from this file. Importing @cp/resources/internal/* from outside this
...
export const MODULE_NAME = "resources" as const;
