// /observations — public interface.
//
// Responsibility (architecture §36): factual execution/provider observations.
//
...
// from this file. Importing @cp/observations/internal/* from outside this
...
export const MODULE_NAME = "observations" as const;
