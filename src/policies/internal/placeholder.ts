// /policies/internal/placeholder.ts
// Private implementation surface for /policies. Reserved for the concrete
// implementation delivered in later work items. Importing this file (or any
// other file under @cp/policies/internal/*) from outside /policies is a
// forbidden cross-module internal import and is rejected by the static
// architecture check (architecture-lock §8).

export const INTERNAL_MODULE = "policies" as const;
