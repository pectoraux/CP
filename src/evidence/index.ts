// /evidence — public interface.
//
// Responsibility (architecture §36): evidence references and evidence lifecycle.
//
...
// from this file. Importing @cp/evidence/internal/* from outside this
...
export const MODULE_NAME = "evidence" as const;
