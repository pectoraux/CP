...
//
// Responsibility (architecture §36): candidate routing and provider selection.
//
...
// from this file. Importing @cp/routing/internal/* from outside this
...
export const MODULE_NAME = "routing" as const;
