// /capabilities/internal/placeholder.ts
// Private implementation surface for /capabilities. Reserved for the concrete
// implementation delivered in later work items. Importing this file (or any
// other file under @cp/capabilities/internal/*) from outside /capabilities is a
// forbidden cross-module internal import and is rejected by the static
// architecture check (architecture-lock §8).

export const INTERNAL_MODULE = "capabilities" as const;
