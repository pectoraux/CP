// /goals/internal/placeholder.ts
// Private implementation surface for /goals. Reserved for the concrete
// implementation delivered in later work items. Importing this file (or any
// other file under @cp/goals/internal/*) from outside /goals is a
// forbidden cross-module internal import and is rejected by the static
// architecture check (architecture-lock §8).

export const INTERNAL_MODULE = "goals" as const;
