...
//
// Responsibility (architecture §36): normalized marketplace inventory and provider capability facts.
//
...
// from this file. Importing @cp/catalog/internal/* from outside this
