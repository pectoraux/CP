// /experiments/internal/placeholder.ts
// Private implementation surface for /experiments. Reserved for the concrete
// implementation delivered in later work items. Importing this file (or any
// other file under @cp/experiments/internal/*) from outside /experiments is a
// forbidden cross-module internal import and is rejected by the static
// architecture check (architecture-lock §8).

export const INTERNAL_MODULE = "experiments" as const;
