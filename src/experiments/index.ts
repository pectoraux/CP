// /experiments — public interface.
//
// Responsibility (architecture §36): replay, simulation, shadow, canary, evaluation, promotion/rollback.
//
...
// from this file. Importing @cp/experiments/internal/* from outside this
...
export const MODULE_NAME = "experiments" as const;
