...
//
// Responsibility (architecture §36): authentication, authorization primitives, sessions, API authentication.
//
...
// from this file. Importing @cp/auth/internal/* from outside this
