...
//
// Responsibility (architecture §36): domain/customer event publication.
//
...
// from this file. Importing @cp/events/internal/* from outside this
...
export const MODULE_NAME = "events" as const;
