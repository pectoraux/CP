...
//
// Responsibility (architecture §36): provider-neutral LLM access and reasoning services.
//
...
// from this file. Importing @cp/llm/internal/* from outside this
...
export const MODULE_NAME = "llm" as const;
