...
//
// Responsibility (architecture §36): provider-neutral agent/tool execution where needed.
//
...
// from this file. Importing @cp/agents/internal/* from outside this
...
export const MODULE_NAME = "agents" as const;
