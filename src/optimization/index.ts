// /optimization — public interface.
//
// Responsibility (architecture §36): analysis, candidate strategy generation, optimization recommendations.
//
...
// from this file. Importing @cp/optimization/internal/* from outside this
...
export const MODULE_NAME = "optimization" as const;
